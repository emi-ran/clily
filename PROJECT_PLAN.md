...
| 2026-04-04 | OpenCode | Added a cached npm update checker with a non-blocking startup refresh, one-time version notices, `CLILY_DISABLE_UPDATE_CHECK`, and README/test coverage. |
